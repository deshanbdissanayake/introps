	...
	<section class="pos-rel pd-tb-small bg-gray" data-rgen-sm="pd-tb-small" id="portfolio">
		<div class="container" data-animate-in="fadeIn">
			<div class="w75 mr-auto align-c">
				<h2 class="title" data-rgen-sm="small">What is invigo?</h2>
			...
			<div class="rw eq3 gt20 mb20 popgallery-widget">
				...
				<div class="cl" data-animate-in="fadeInUp|0.1">
					<h3 class="title mini bold-n align-c">Home Page</h3>
					<figure class="hover-box1">
						...
						<div class="overlay flex-cc full-wh">
							<div class="content pos-rel z1">
								<a href="images/800x600_1.jpg" class="sq60 mr-6 bg-primary rd fs24 z1 iconbox pop-img"><i class="pe-7s-expand1"></i></a>	
							</div>
							<b class="full-wh bg-dark op-08"></b>
						</div>
						<img src="images/800x600_1.jpg" alt="image">
					</figure>
				</div><!-- // END : column //  -->
