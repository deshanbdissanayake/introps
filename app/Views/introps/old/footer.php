	...
	<footer class="pos-rel pd-tb-small bg-dark" data-rgen-sm="pd-tb-small">
		<div class="container typo-light" data-rgen-sm="align-c">
			<div class="row gt20 mb20">
				<div class="col-md-5">
					<p><a href="#" class="inline-block max-px-w150"><img src="/images/introps-logo.png" class="max-px-w140" alt="logo"></a></p>
					<p class="addressf">NO 54, Katugastota Road,<br>Kandy</p>
					
					<!--=========================================
					=  Social links
					=============================================-->
					<a href="www.facebook.com" target="_blank" class="sq30 fs16 mr-r-4 rd-4 iconbox btn-white"><i class="fab fa-facebook-f"></i></a>
					<a href="#" target="_blank" class="sq30 fs16 mr-r-4 rd-4 iconbox btn-white"><i class="fab fa-instagram"></i></a>
					...
					<a href="#" target="_blank" class="sq30 fs16 mr-r-4 rd-4 iconbox btn-white"><i class="fab fa-linkedin"></i></a>
				</div><!-- // END : Column //  -->
