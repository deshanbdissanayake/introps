<section class="pd-tb-small pos-rel" data-rgen-sm="pd-tb-small align-c" id="about">
			...
			<div class="col-md-7 offset-md-1 d-flex align-items-end">
				<div class="row gt20 mb20">
					<div class="col-md-6" data-animate-in="fadeInUp|0.1">
						<div class="info-obj img-t g20 mini">
							<div class="img"><span class="iconwrp txt-default"><i class="pe-7s-phone"></i></span></div>
							<div class="info">
								<h3 class="title mini bold-n">Fully responsive</h3>
								<p class="mr-0">Lorem ipsum dolor sit ametconsetetur sadipscing nonumy eirmod</p>
							</div>
						</div><!-- info box -->
					</div><!-- // END : column //  -->
					
					<div class="col-md-6" data-animate-in="fadeInUp|0.2">
						<div class="info-obj img-t g20 mini">
							<div class="img"><span class="iconwrp txt-default"><i class="pe-7s-photo-gallery"></i></span></div>
							<div class="info">
								<h3 class="title mini bold-n">Flexible design</h3>
								<p class="mr-0">Lorem ipsum dolor sit ametconsetetur sadipscing nonumy eirmod</p>
							</div>
						</div><!-- info box -->
					</div><!-- // END : column //  -->
					...
					<div class="col-md-6" data-animate-in="fadeInUp|0.3">
						<div class="info-obj img-t g20 mini">
							<div class="img"><span class="iconwrp txt-default"><i class="pe-7s-photo"></i></span></div>
							<div class="info">
								<h3 class="title mini bold-n">Parallax background</h3>
								<p class="mr-0">Lorem ipsum dolor sit ametconsetetur sadipscing nonumy eirmod</p>
							</div>
						</div><!-- info box -->
					</div><!-- // END : column //  -->
					...
					<div class="col-md-6" data-animate-in="fadeInUp|0.3">
						<div class="info-obj img-t g20 mini">
							<div class="img"><span class="iconwrp txt-default"><i class="pe-7s-paint-bucket"></i></span></div>
							<div class="info">
